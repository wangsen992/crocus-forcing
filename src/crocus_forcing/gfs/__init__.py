"""
GFS forcing data source - stub for future implementation
"""
...
class GFSForcing(ForcingSource):
    """GFS forcing - not yet implemented"""

    def download(self, config: Dict[str, Any], output_dir: Path) -> Path:
        raise NotImplementedError("GFS forcing not yet implemented")
